...
| `alps-ssss2.pdf` | ALPS Alpine SSSS2 Series slide switch datasheet — 3.5(H)mm, 2mm-travel, through-hole SPDT. SSSS213100 = horizontal actuator, 1-pole 2-position, 300mA 6V DC, 10k cycles. Used as SW21 (power on/off via TPS63021 EN pin). LCSC C115374. **Note: SSSS213100 not confirmed on DigiKey — may need LCSC sourcing or C&K SS-12D1505-G 2 alternative.** | http://www.stm32circle.com/resources/Datasheets/ALPS_SSSS2.pdf |
