---
name: kicad-pcb-edit
description: "DORMANT (2026-08-16 role change): Governed write workflow for .kicad_pcb files. Invoke only on explicit user request — user now drives all KiCad edits, agent reviews."
status: dormant
triggers:
  - user
subagent: true
